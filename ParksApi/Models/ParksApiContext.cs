  ...
  public class ParksApiContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      .HasData(
        ...
        new Park { ParkId = 5, Name = "Hells Canyon National Recreation Area", DogsAllowed = true, ParkMgmt = "National Park", Location = "NE Oregon", Description = "Beautiful Scenery, boasting of the deepest river gorge in North America, features fishing, swimming, camping, and kayaking" },
        new Park { ParkId = 6, Name = "Newberry National Volcanic Monument ", DogsAllowed = true, ParkMgmt = "National Park", Location = "Central Oregon", Description = "Home to spectacular lakes and lava flows.Formed after a violent volcanic eruption, Newberry Caldera is now home to the two arresting alpine lakes of Paulina Lake and East Lake. Features hiking and horse back riding." },
        ...
        new Park { ParkId = 11, Name = "Columbia River Gorge National Senic Area", DogsAllowed = true, ParkMgmt = "National Park", Location = "NW Oregon", Description = "The national scenic areas delightful and diverse landscapes lend themselves perfectly to all kinds of outdoor activities, with everything from hiking and mountain biking to rock climbing and rafting on offer." },
